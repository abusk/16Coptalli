...
var bots_coponent_1 = require("./components/bots.coponent");
...
AppModule = __decorate([
    core_1.NgModule({
        declarations: [
            ...
            bots_coponent_1.BotsComponent,
            player_component_1.PlayerComponent,
            playboard_component_1.PlayBoardComponent
        ],
        imports: [
            platform_browser_1.BrowserModule,
            forms_1.FormsModule,
            http_1.HttpModule, app_router_1.AppRouter
        ],
        providers: [],
